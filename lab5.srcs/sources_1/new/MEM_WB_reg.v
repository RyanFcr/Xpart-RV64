...
module MEM_WB_reg(
    ...
    input [63:0] imm_EX_MEM, 
    input [63:0] res_EX_MEM, 
    input [63:0] data_in, 
    input [1:0] mem_to_reg_EX_MEM, 
    input [63:0] pc_src_EX_MEM, 
    input [31:0] inst_EX_MEM, 
    input reg_write_EX_MEM, 
    input [63:0] csr_out_EX_MEM, 
    ...
    output reg [63:0] pc_src_MEM_WB, 
    output reg [31:0] inst_MEM_WB, 
    output reg reg_write_MEM_WB, 
    output reg [63:0] imm_MEM_WB, 
    output reg [63:0] pc_MEM_WB, 
    output reg [63:0] csr_out_MEM_WB, 
