...
module immgen(
    ...
    wire [63:0] I_imm, S_imm, B_imm, J_imm, U_imm, CSR_imm; 
    assign I_imm = {{52{inst[31]}}, inst[31:20]};
    assign S_imm = {{52{inst[31]}}, inst[31:25], inst[11:7]};
    assign B_imm = {{52{inst[31]}}, inst[7], inst[30:25], inst[11:8],1'b0};
    assign J_imm = {{52{inst[31]}}, inst[19:12], inst[20], inst[30:21],1'b0};
    assign U_imm = {32'b0, inst[31:12], 12'b0};
    assign CSR_imm = {59'b0, inst[19:15]}; 
