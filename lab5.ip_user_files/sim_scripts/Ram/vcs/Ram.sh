...
#
# Generated by Vivado on Wed Jun 14 22:46:20 +0800 2023
...
# Script info
echo -e "Ram.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../lab5.srcs/sources_1/ip/Ram/sim/Ram.v" \
  2>&1 | tee -a vlogan.log
